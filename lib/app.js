...
(function() {
  ...
  __t('navi').Page = (function() {
    ...
    Page.prototype["in"] = function(callback) {
      var _this = this;
      this.animating_in = true;
      this.el = this.object.render();
  ...
  __t('navi').Main = (function() {
    ...
    Main.map = function(hash, object, el_target) {
      ...
      return window.page("/#" + hash, function(ctx) {
        return _this.process_hash_change(decorator.route);
      });
    };
    ...
    Main.process_hash_change = function(page_name) {
      Main.events.trigger("route_change");
      return Main.change_page(page_name);
    };

    Main.change_page = function(page_name) {
      var _this = this;
      this.next_page = page_name;
      if (this.current_page) {
        return this.remove_current_page(function() {
          return _this.add_next_page();
        });
      } else {
        return this.add_next_page();
      }
    };
